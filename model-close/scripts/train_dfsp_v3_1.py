...
# V3'te 1.0 idi.
# V3.1'de BBox görevine daha fazla ağırlık veriyoruz.
BBOX_WEIGHT = 2.0

V2_MODEL = ROOT / "dfsp_hrnet_v2_best.pth"
V3_1_MODEL = ROOT / "dfsp_hrnet_v3_1_best.pth"
...
print("V2 weights loaded:", loaded)
print("Skipped/new parameters:", skipped)
...
print()
print("========================================")
print("DFSP V3.1 CENTER + BBOX FINE-TUNING")
print("========================================")
print("Device:", DEVICE)
...
for epoch in range(EPOCHS):
    ...
    if val_total < best_val_loss:
        ...
        print(
            "  -> Best V3.1 model saved."
        )


print()
print("========================================")
print("DFSP V3.1 TRAINING FINISHED")
print("========================================")
print("Best validation loss:", best_val_loss)
print("Checkpoint:", V3_1_MODEL)
